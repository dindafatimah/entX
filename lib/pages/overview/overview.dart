...
import 'package:flutter_web_dashboard/pages/overview/widgets/recent_lendings_table.dart';
...
import 'package:flutter_web_dashboard/pages/overview/widgets/chart_section_large.dart';
import 'package:flutter_web_dashboard/widgets/custom_text.dart';
import 'package:get/get.dart';

import 'widgets/chart_section_small.dart';
        ...
        Expanded(
          child: ListView(
            children: [
              ...
              if (!ResponsiveWidget.isSmallScreen(context)) const ChartSectionLarge() else const ChartSectionSmall(),
              const RecentLendingsTable(),
            ],
          ),
        ),
      ],
